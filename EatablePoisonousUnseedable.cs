...
{
    class EatablePoisonousUnseedable : Plant //purple
    {
        ...
        {
            var newPlant = new EatablePoisonousUnseedable();
        ...
        public override void CheckAge(int SeasonDamage, string CurrentSeason)
        {
            ...
            if (50 >= lifeTime && lifeTime > 10) //растение
            {
                ...
                imageToDraw = Image.FromFile("C:\\Users\\Lotts\\source\\repos\\LifeSimulator2\\LifeSimulator2\\Images\\eatablepoisonousunseedable.jpg");
                lifeTime -= SeasonDamage;
            }
