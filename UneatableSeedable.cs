...
{
    class UneatableSeedable : Plant //grey
    {
        ...
        {
            var newPlant = new UneatableSeedable();
        ...
        public override void CheckAge(int SeasonDamage, string CurrentSeason)
        {
            ...
            if (50 >= lifeTime && lifeTime > 10) //растение
            {
                ...
                imageToDraw = Image.FromFile("C:\\Users\\Lotts\\source\\repos\\LifeSimulator2\\LifeSimulator2\\Images\\uneatableseedable.jpg");
                lifeTime -= SeasonDamage;
            }
